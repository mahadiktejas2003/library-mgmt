...
<head>
  ...
  <title>BookGuardian | Update Book</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <?php
                ...
                $selectquery = " select * from book  WHERE bookid='$id' ";
              ...
              <form method="POST"> 
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $res1['name']; ?>" name="book_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Book Name">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">ISBN Number</label>
                    <input type="text" value="<?php echo $res1['isbn']; ?>" name="isbn_number" class="form-control" id="exampleInputEmail1" placeholder="Enter ISBN">
                  </div>
                  <div class="form-group">
