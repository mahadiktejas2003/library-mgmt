...
<head>
  ...
  <title>BookGuardian | Update author</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <?php
                ...
                $selectquery = " select * from author WHERE authorid='$id' ";
              ...
              <form method="POST"> 
                ...
                <div class="card-footer">
                  <button type="submit" name="submit" class="btn btn-primary">Update author</button>
                </div>
              </form>
              <?php
                }
