...
<head>
  ...
  <title>BookGuardian | Update Student</title>
              ...
              <form method="POST"> 
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $res1['first_name']; ?>" name="first_name" class="form-control" id="exampleInputEmail1" placeholder="Enter First Name">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $res1['email']; ?>" name="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Last Name">
                  </div>
