...
<head>
  ...
  <title>BookGuardian | Manage Users</title>
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="manage_users.php" style="color: brown;" class="nav-link">Users</a>
        </li>
      </ul>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="php/AddUserAction.php" method="POST"> 
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Student PRN</label>
                    <input type="number" name="prn" class="form-control" id="exampleInputEmail1" placeholder="Enter Student PRN">
                  </div>
                  <div class="form-group">
