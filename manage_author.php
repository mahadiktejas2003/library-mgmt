...
<head>
  ...
  <title>BookGuardian | Manage Author</title>
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="manage_author.php" style="color: brown;" class="nav-link">Authors</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="php/AddAuthorAction.php" method="POST"> 
                <div class="card-body">
      ...
      <section class="col-lg-12 connectedSortable">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Current Author</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
