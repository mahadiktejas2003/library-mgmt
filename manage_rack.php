...
<head>
  ...
  <title>BookGuardian | Manage Rack</title>
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="manage_rack.php" style="color: brown;" class="nav-link">Racks</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <!-- Add icons to the links using the .nav-icon class
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="manage_rack.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Manage Racks</p>
                  </a>
                </li>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Rack</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="php/AddRackAction.php" method="POST"> 
                <div class="card-body">
                ...
                <div class="card-footer">
                  <button type="submit" name="submit" class="btn btn-primary">Add Rack</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
