...
<?php
   ...
   if (isset($_POST['submit'])) {
    ...
    $updateQuery = "UPDATE `publisher` SET `name`='$publisher_name' WHERE `publisherid`=$id" ;
...
<head>
  ...
  <title>BookGuardian | Update Publisher</title>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <!-- Add icons to the links using the .nav-icon class
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="manage_publisher.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <?php
                ...
                $selectquery = " select * from publisher WHERE publisherid='$id' ";
              ...
              <form method="POST"> 
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $res1['name']; ?>" name="publisher_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Publisher Name">
                  </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
                  <button type="submit" name="submit" class="btn btn-primary">Update Publisher</button>
                </div>
              </form>
              <?php
                }
