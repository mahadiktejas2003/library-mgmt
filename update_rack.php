...
<head>
  ...
  <title>BookGuardian | Update Rack</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update Rack</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <?php
                ...
                $selectquery = " select * from rack WHERE rackid='$id' ";
              ...
              <form method="POST"> 
                ...
                <div class="card-footer">
                  <button type="submit" name="submit" class="btn btn-primary">Update Rack</button>
                </div>
              </form>
              <?php
                }
